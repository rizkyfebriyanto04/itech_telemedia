...
let itemCount = $('#testimonial_slider .item').length;

$('#testimonial_slider').owlCarousel({
    loop: itemCount > 1, // loop hanya kalau lebih dari 1 item
    margin: 10,
    nav: false,
    autoplay: itemCount > 1, // autoplay hanya kalau lebih dari 1
    smartSpeed: 2500,
    dots: itemCount > 1, // dots juga hanya kalau lebih dari 1
    responsive: {
        0: {
