        ...
        <nav class="navbar navbar-expand-lg">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item has_dropdown">
                <a class="nav-link" href="#how_it_work">Cara Daftar</a>
              </li>
              <li class="nav-item has_dropdown">
                <a class="nav-link" href="pricing.html">Isi Saldo</a>
              </li>
              <li class="nav-item has_dropdown">
          ...
          <div id="testimonial_slider" class="owl-carousel owl-theme">
            ...
            <div class="item">
              <div class="testimonial_slide_box">
                ...
                <div class="testimonial_img">
                  <img src="{{asset('landing/images/testimonial_user2.png')}}" alt="image" >
                </div>
                <h3>Willium Den</h3>
                <span class="designation">Careative inc</span>
              </div>
            ...
            <div class="item">
              <div class="testimonial_slide_box">
                ...
                <div class="testimonial_img">
                  <img src="{{asset('landing/images/testimonial_user3.png')}}" alt="image" >
                </div>
                <h3>Cyrus Stephen</h3>
                <span class="designation">Careative inc</span>
              </div>
